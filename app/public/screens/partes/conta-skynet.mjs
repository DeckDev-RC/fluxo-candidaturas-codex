...
export function skynetPanel() {
  ...
  return panel({
    ...
    actions: [
      ...
      badge(connected ? 'conectado' : 'login necessário', connected ? 'sucesso' : 'atencao')
    ],
    children: [
      ...
      el('div', { class: 'linha-acoes' }, [
        connected ? button('Sair do SkynetChat', { variant: 'texto', onClick: confirmarSaida }) : loginButton(),
