...
test('a assinatura da ação cobre o que a IA pediu e ignora o resto', () => {
  ...
  assert.notEqual(assinaturaDaAcao({ type: 'click', role: 'button', name: 'Entrar' }), assinaturaDaAcao({ type: 'click', role: 'button', name: 'Entrar', confirmed: true }), 'repetir com confirmed=true é outra ação');
