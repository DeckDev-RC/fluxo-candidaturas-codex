...
Evidência nesta base: 355 testes do app, 14 do desktop e 25 de navegador real (Chromium). Uma sessão autorizada confirmou o formato de resposta da plataforma; nomes, identificadores e evidências reais foram removidos da versão pública. O fluxo de envio do app permanece validado por fixture fiel e dados sintéticos.
