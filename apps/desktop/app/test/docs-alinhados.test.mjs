...
// O desktop e o pacote PowerShell compartilham contratos e checklists. Quando
...
const PRINCIPAL = fileURLToPath(new URL('../../../../packages/powershell/docs/', import.meta.url));
...
const SO_DO_APP = new Set([
  ...
  'CHECKLIST-NAVEGADOR-PLAYWRIGHT.md',
  'CONSOLIDACAO.md',
